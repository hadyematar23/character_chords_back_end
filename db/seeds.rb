...
debug = Theme.create!(title: "Debugging Test", name: "Debugger Test!!", image_link: "https://media.istockphoto.com/id/1202688372/photo/error-programming-social-networking-seo-search-and-service-delivery-concept-chart-with.jpg?s=1024x1024&w=is&k=20&c=I0Oued_6FvH_MoQo98ccgZ4WRc6r-OdQTBZYjv9J0gY=")
# Good/Evil Question
Question.create(
  theme_id: debug.id,                                     
...
lawyer = Theme.create!(title: "Want To Know Which Famous Lawyer You're Most Like? Take This Quiz And Achieve Ultimate Enlightenment!", name: "lawyer", image_link: "https://images.pexels.com/photos/3771097/pexels-photo-3771097.jpeg")
# Good/Evil Questions
# 1
Question.create(
  theme_id: lawyer.id,                                     
...
alignment = Theme.create!(title:"Discover Your True Nature With This Fun DnD Alignment Quiz", name: "alignment", image_link: "https://images.pexels.com/photos/137049/pexels-photo-137049.jpeg")
# Good/Evil Questions
# 1
Question.create!(
...
star_wars = Theme.create!(title: "May The Force Be With You: Discover Your Inner Star Wars Character With This Quiz", name: "Star Wars Character", image_link: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Star_wars2.svg/225px-Star_wars2.svg.png")
# Good/Evil Questions
# 1
Question.create(
...
# Character Creation
Character.create!(name: "Luke Skywalker", theme_id: star_wars.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.67, lawful_max: 1.00, url: "https://upload.wikimedia.org/wikipedia/commons/6/67/Luke_Skywalker_-_Welcome_Banner_%28Cropped%29.jpg", alignment: 1, description: "You are Luke Skywalker, a noble knight who is always willing to put the needs of others before your own. You value honor and integrity above all else, and will fight for what is right no matter the cost. You are a loyal and trusted friend, and always strive to do what is best for those you care about.")
Character.create!(name: "Leia Organa", theme_id: star_wars.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.34, lawful_max: 0.66, url: "https://upload.wikimedia.org/wikipedia/en/1/1b/Princess_Leia%27s_characteristic_hairstyle.jpg?20190831062334", alignment: 2, description: "You are a person of great compassion and understanding. You are always looking out for the good of others and are willing to sacrifice yourself for the greater good. You are fair and just, and you have a strong sense of right and wrong. You have a strong moral compass and will do what is necessary to protect the innocent. You are an optimist who believes that good will ultimately prevail.")
Character.create!(name: "Han Solo", theme_id: star_wars.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.00, lawful_max: 0.33, url: "https://upload.wikimedia.org/wikipedia/en/b/be/Han_Solo_depicted_in_promotional_image_for_Star_Wars_%281977%29.jpg", alignment: 3, description: "You are a rebellious, independent spirit who values freedom and personal autonomy above all else. You believe in doing what is right and helping others, but you do not fit into traditional definitions of good and evil. You are a risk-taker who follows their own moral compass, and you stand up for what you believe in even when it puts you at odds with the law. You are often seen as a wild card and a bit of a loose cannon, but you are loyal and trustworthy to those you care about.")

Character.create!(name: "C-3PO", theme_id: star_wars.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.67, lawful_max: 1.00, url: "https://upload.wikimedia.org/wikipedia/en/5/5c/C-3PO_droid.png?20180102220614", alignment: 4, description: " The loyal droid of Anakin Skywalker, and a staunch defender of justice. You stay true to your beliefs and adhere to the law, but are willing to break it if it will help those in need. You are an expert in etiquette and protocol, and strive to keep the peace.")
Character.create!(name: "Boba Fett", theme_id: star_wars.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.34, lawful_max: 0.66, url: "https://upload.wikimedia.org/wikipedia/en/3/3e/FettbobaJB.png?20100126122410", alignment: 5, description: "You are Boba Fett, a self interested, lawless, bounty hunter. True Neutral means you are neutral in regards to good and evil and have no bias towards either. You believe that order and chaos have a natural balance and seek to maintain it, seeking neither too much nor too little of either. Your decisions are based on what is most practical and you may be willing to work with anyone or anything if it benefits you.")
Character.create!(name: "Lando Calrissian", theme_id: star_wars.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.00, lawful_max: 0.33, url: "https://upload.wikimedia.org/wikipedia/en/c/cb/Lando6-2.jpg?20171217221509", alignment: 6, description: "You are Lando Calrissian a charming, daring, and ambitious scoundrel with a heart of gold. You are fiercely independent and often find yourself in difficult situations, but you always manage to find a way out. You don't follow the rules and often go against the grain. You're loyal to your friends and always up for a good time.")

Character.create!(name: "Darth Vader", theme_id: star_wars.id, good_min: 0.00, good_max: 0.33, lawful_min: 0.67, lawful_max: 1.00, url: "https://upload.wikimedia.org/wikipedia/en/0/0b/Darth_Vader_in_The_Empire_Strikes_Back.jpg?20211020000259", alignment: 7, description: "Your pragmatism and discipline make you a reliable leader and your commitment to order makes you a powerful asset to any team. Your loyalty to your cause and your ability to work within the rules make you a formidable opponent. However, your willingness to do whatever it takes to get the job done can make you a dangerous enemy.")
Character.create!(name: "Emperor Palpatine", theme_id: star_wars.id, good_min: 0.00, good_max: 0.33, lawful_min: 0.34, lawful_max: 0.66, url: "https://upload.wikimedia.org/wikipedia/en/8/8f/Emperor_RotJ.png?20130207121428", alignment: 8, description: "You are calculating, power-hungry, and amoral. You believe in order and control and will use any means to achieve your goals. You use fear and intimidation to achieve your aims and have no qualms about using underhanded methods or punishing those who stand in your way.")
...
### Harry Potter Quiz ###
harry_potter = Theme.create!(title: "Are You A Hero, Villain, Or An Extra? Take This Harry Potter Character Quiz And Find Out Where You Stand In The Wizarding World!", name: "Harry Potter Character", image_link: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Harry_Potter_wordmark.svg/1280px-Harry_Potter_wordmark.svg.png")
# Good/Evil Questions
# 1
Question.create(
...
# Character Creation
Character.create!(name: "Hermione Granger", theme_id: harry_potter.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.67, lawful_max: 1.00, url: "https://upload.wikimedia.org/wikipedia/en/thumb/d/d3/Hermione_Granger_poster.jpg/220px-Hermione_Granger_poster.jpg", alignment: 1, description: "Hermione Granger is a natural leader who loves to help those in need. She is deeply committed to justice and order and will go to great lengths to protect the innocent. She is fiercely independent and will never back down from a challenge. Hermione is always looking for a way to make the world a better place." )
Character.create!(name: "Harry Potter", theme_id: harry_potter.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.34, lawful_max: 0.66, url: "https://upload.wikimedia.org/wikipedia/en/thumb/d/d7/Harry_Potter_character_poster.jpg/220px-Harry_Potter_character_poster.jpg", alignment: 2, description: "Harry Potter is a brave, loyal and kind-hearted person who is willing to put himself in danger to help others. He is brave and unafraid to stand up for what he believes in, even when faced with opposition or danger. He is loyal to those he loves and willing to put himself in harm's way to protect them. He is kind-hearted and shows compassion for all people, regardless of their background or beliefs. He is an inspiring leader who is willing to take risks and put himself in uncomfortable situations in order to help those in need." )
Character.create!(name: "Ron Weasley", theme_id: harry_potter.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.00, lawful_max: 0.33, url: "https://upload.wikimedia.org/wikipedia/en/thumb/5/5e/Ron_Weasley_poster.jpg/220px-Ron_Weasley_poster.jpg", alignment: 3, description: "Ron Weasley is a brave and loyal friend who will go to great lengths to help those he loves. He is also a bit impulsive and often acts without considering the consequences. He has a strong moral compass and will always try to do what is right for the greater good, even when it means putting himself in danger. He is chaotic good to the core." )

Character.create!(name: "Severous Snape", theme_id: harry_potter.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.67, lawful_max: 1.00, url: "https://upload.wikimedia.org/wikipedia/en/thumb/b/b9/Ootp076.jpg/220px-Ootp076.jpg", alignment: 4, description: "A wizard who loves the rules, but also knows when to bend them in order to get things done. He is the kind of person who would be the first to arrive at a party and the last to leave. He is always looking for the most efficient and effective way to do things, but also knows when to take a break and enjoy life." )
Character.create!(name: "Hedwig", theme_id: harry_potter.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.34, lawful_max: 0.66, url: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/The_Making_of_Harry_Potter_29-05-2012_%28Hedwig%29.jpg/150px-The_Making_of_Harry_Potter_29-05-2012_%28Hedwig%29.jpg", alignment: 5, description: "Hedwig is  a wise and powerful creature. He is free-spirited and independent, rarely taking sides in any conflict and rarely judging others for their decisions. Hedwig values balance, and strives to maintain it in all aspects of his life. He is wise and patient, and he often finds creative solutions to difficult problems." )
Character.create!(name: "Gilderoy Lockhart", theme_id: harry_potter.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.00, lawful_max: 0.33, url: "https://static.wikia.nocookie.net/harrypotter/images/d/d4/Gilderoy_Lockhart_COS_promo.jpg/revision/latest?cb=20160905192348", alignment: 6, description: "Gilderoy Lockhart is a whimsical and charismatic wizard who values personal freedom above all else. He is an adventurer, a risk-taker, and an independent thinker who enjoys exploring the unknown and challenging conventions. He has a strong sense of justice, and will always do what he believes is right, even if it means going against the grain. He is unpredictable and sometimes irresponsible, but he always has a plan in mind and will use his wit and charm to get what he wants." )

Character.create!(name: "Voldemort", theme_id: harry_potter.id, good_min: 0.00, good_max: 0.33, lawful_min: 0.67, lawful_max: 1.00, url: "https://upload.wikimedia.org/wikipedia/en/thumb/a/a3/Lordvoldemort.jpg/220px-Lordvoldemort.jpg", alignment: 7, description: "Voldemort is a powerful and ruthless wizard. He has no qualms about using his power to control and manipulate those around him. He believes in absolute loyalty and obedience to himself and his cause. He is willing to do whatever it takes to achieve his goals, no matter how dark and terrible the means might be. He has a twisted sense of justice, believing that the ends justify the means. He is a master of dark magic and will not hesitate to use it against his enemies." )
Character.create!(name: "Lucius Malfoy", theme_id: harry_potter.id, good_min: 0.00, good_max: 0.33, lawful_min: 0.34, lawful_max: 0.66, url: "https://static.wikia.nocookie.net/harrypotter/images/b/b4/Lucius_Malfoy_BoH.png/revision/latest/scale-to-width-down/338?cb=20190604135420", alignment: 8, description: "Lucius Malfoy is a devious and cunning character with a penchant for dark magic and a thirst for power. He is manipulative, calculated, and will do whatever it takes to get what he wants, even if it means hurting those around him. His loyalty lies with himself and no one else, and he will take advantage of any situation he can to further his own goals." )
...
lotr = Theme.create!(title: "Sauron or Samwise, take this LOTR character alignment to find where you stand in the fight for Middle Earth!", name: "Lord of the Rings Character", image_link: "https://upload.wikimedia.org/wikipedia/en/8/8a/The_Lord_of_the_Rings_The_Fellowship_of_the_Ring_%282001%29.jpg")
# Good/Evil Questions
# 1
Question.create(
  theme_id: lotr.id,
...
# Character Creation
Character.create!(name: "Aragorn", theme_id: lotr.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.67, lawful_max: 1.00, url: "https://upload.wikimedia.org/wikipedia/en/thumb/3/35/Aragorn300ppx.png/170px-Aragorn300ppx.png", alignment: 1, description: "You are Aragorn, a noble ranger of the North. You are a brave leader, who follows the strict code of honor and justice. You fight for the greater good and are willing to do whatever it takes to protect your people and the innocent.")
Character.create!(name: "Frodo", theme_id: lotr.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.34, lawful_max: 0.66, url: "https://upload.wikimedia.org/wikipedia/en/thumb/4/4e/Elijah_Wood_as_Frodo_Baggins.png/170px-Elijah_Wood_as_Frodo_Baggins.png", alignment: 2, description: "You are Frodo Baggins, a brave and kindhearted hobbit who is willing to do what’s necessary for the greater good. You are unselfish, generally kind, and very compassionate. You are devoted to preserving life, and are willing to take risks to help others.")
Character.create!(name: "Pippin", theme_id: lotr.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.00, lawful_max: 0.33, url: "https://static.wikia.nocookie.net/pjhobbitlotr/images/8/86/PippinBoyd.png/revision/latest?cb=20170219174505", alignment: 3, description: "You are Pippin Took, a brave, daring and adventurous hobbit. You value freedom and have a strong sense of justice. You are loyal and kind-hearted, but can be impulsive and reckless. You are fiercely independent and thrive on taking risks." )

Character.create!(name: "Boromir", theme_id: lotr.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.67, lawful_max: 1.00, url: "https://static.wikia.nocookie.net/pjmidearthfilms/images/b/b4/Seanbean_boromir.jpg/revision/latest?cb=20150513011509", alignment: 4, description: "You are Boromir, Son of Denethor, a stalwart and courageous warrior from Gondor. You are loyal to your family and your people, and always strive to do what is right and just. You are wise and have a strong sense of justice, but can be stubborn and uncompromising at times.")
Character.create!(name: "Treebeard", theme_id: lotr.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.34, lawful_max: 0.66, url: "https://static.wikia.nocookie.net/pjmidearthfilms/images/6/67/Treebeard_ROTK_1.png/revision/latest/scale-to-width-down/350?cb=20211030072336", alignment: 5, description: "You're Treebeard, the Ent of Fangorn Forest. You're a neutral character that likes to keep things balanced in the world, but don't mess with your home and its inhabitants - you'll get a good Ent-ing!")
Character.create!(name: "Gollum", theme_id: lotr.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.00, lawful_max: 0.33, url: "https://static.wikia.nocookie.net/pjmidearthfilms/images/e/e1/Gollum_Render.png/revision/latest?cb=20151102075339", alignment: 6, description: "You are Gollum, the master of tricks and riddles, and you live by no law or code other than your own. You'll do whatever it takes to get what you want, even if it means taking something from someone else. Your motto is \"what's mine is mine and what's yours is mine too!\"")
...
coder = Theme.create!(title: "Techies Unite: Find out Which Side of the Digital Divide You're on with Our CyberQuiz", name: "coder", image_link: "https://cdn-media-1.freecodecamp.org/images/1*2TWW_kmC28W_rfXJqT6oPg.jpeg")
...
Character.create!(name: "White Hat Hacker", theme_id: coder.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.67, lawful_max: 1.00, url: "https://static.wikia.nocookie.net/loshackers/images/0/05/White-Hat-Hacker-1.jpg/revision/latest?cb=20190811075735&path-prefix=es", alignment: 1, description: "This coder is highly ethical and uses their skills for the greater good. They may work to improve security and prevent cybercrime, and may even work with law enforcement agencies to catch cybercriminals.")
Character.create!(name: "The Open Source Advocate", theme_id: coder.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.34, lawful_max: 0.66, url: "https://www.itsecurityguru.org/wp-content/uploads/2015/10/hosting-dens-free-website_development.png", alignment: 2, description: "This coder is passionate about open-source software and collaboration. They may contribute to open-source projects and work to make code more accessible and widely available.")
Character.create!(name: "Whistleblower aka Anonymous", theme_id: coder.id, good_min: 0.67, good_max: 1.00, lawful_min: 0.00, lawful_max: 0.33, url: "https://www.eltiempo.com/files/image_640_428/uploads/2017/06/27/595317e8f0820.jpeg", alignment: 3, description: "This coder is willing to break rules and take risks to expose corruption or unethical behavior. They may use their coding abilities to uncover secrets and bring about positive change." )

Character.create!(name: "IT Administrator", theme_id: coder.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.67, lawful_max: 1.00, url: "https://trackersuite.net/graphics/carlos_frustration.gif", alignment: 4, description: "This coder is highly skilled at maintaining computer systems and networks. They may work to ensure that systems are secure and reliable, but may also be resistant to change or innovation.")
Character.create!(name: "Code Connoisseur", theme_id: coder.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.34, lawful_max: 0.66, url: "https://thesecondangle.com/wp-content/uploads/2022/03/image1-1.png", alignment: 5, description: " This coder is highly knowledgeable about different coding practices and may have a deep understanding of multiple programming languages. They may not have a particular agenda, but may be highly respected in the coding community for their expertise.")
Character.create!(name: "Grey Hat Hacker", theme_id: coder.id, good_min: 0.34, good_max: 0.66, lawful_min: 0.00, lawful_max: 0.33, url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdcy3t3ltz3l-YTtgcPEjRft2XujmsxH4x_Q&usqp=CAU", alignment: 6, description: "This coder is willing to break rules and push boundaries, but may not necessarily have any particular ethical or moral code. They may use their skills for good or evil purposes, depending on their whims at the time.")

Character.create!(name: "Corporate Spy", theme_id: coder.id, good_min: 0.00, good_max: 0.33, lawful_min: 0.67, lawful_max: 1.00, url: "https://media.newyorker.com/photos/60f5d8c64b5c199789e01980/4:3/w_2276,h_1707,c_limit/Lee-Allgood-Spy.jpg", alignment: 7, description: "This coder is highly skilled at gathering information and may work for companies or governments to steal secrets from competitors or other organizations. They may use their skills for financial gain or to gain a competitive advantage.")
Character.create!(name: "Black Hat Hacker", theme_id: coder.id, good_min: 0.00, good_max: 0.33, lawful_min: 0.34, lawful_max: 0.66, url: "https://atos.net/wp-content/uploads/2020/07/hacking-blog-image.jpg", alignment: 8, description: "This coder is highly skilled at breaking into computer systems and networks. They may use their skills for personal gain, to steal sensitive information or cause damage to computer systems for malicious purposes.")
Character.create!(name: "Cyberterrorist", theme_id: coder.id, good_min: 0.00, good_max: 0.33, lawful_min: 0.00, lawful_max: 0.33, url: "https://s3.envato.com/files/f0e545c9-40a8-4a2d-ac63-c982e457748f/inline_image_preview.jpg", alignment: 9, description: "This coder is highly skilled at causing chaos and destruction through their use of computer systems. They may create viruses or malware, engage in cyberattacks, or use their abilities to cause harm to individuals or organizations.")